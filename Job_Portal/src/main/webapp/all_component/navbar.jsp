...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="view_applicants.jsp"><i class="fa-solid fa-eye"></i>Applicants</a>
      </li>
      </c:if>
      ...
      <div class="modal-body">
        <div class="card">
          <div class="card-body">
            ...
            <button type="button" class="btn btn-primary btn-block" id="takeTestBtn">Take Test</button>
          </div>
        </div>
      </div>
...
<script>
  document.getElementById('takeTestBtn').addEventListener('click', function() {
    // Redirect to the quiz website URL
    window.open('https://example.com/quiz-website', '_blank');
  });
</script>
